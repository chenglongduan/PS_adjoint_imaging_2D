...
par_rtm=(
	...
	velocity_adj="./model/vp_40m.rsf"  #un-padded model, rsf file
	...
	src_wlt="./wavelet/wlt_stalta.rsf"  #rsf file
	time_delay=0.0
	outsrc=1
	outdir_src="./wavelet/out/"    #bin file
	recv_dir="./receiver/"  # [dir/]rec_shot?.txt
	dat_dir_prefix="./data/P_2layer/stalta/rsf/refl" #rsf file([dir/prefix]_p.shot%d.rsf)
	do_srcwfd=1
	...
	imgName="./result/pp_stalta_2layer.rsf"  #rsf file
