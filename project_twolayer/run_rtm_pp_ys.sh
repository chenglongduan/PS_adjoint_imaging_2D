...
par_rtm=(
	...
	velocity_adj="./model/ys_homo/vp.rsf"  #un-padded model, rsf file
	...
	dat_dir_prefix="./data/ys_sta_lta/Z/pp_ps/rsf/refl" #rsf file([dir/prefix]_p.shot%d.rsf)
	do_srcwfd=1
	...
	imgName="./result/vz_pp_dt0.rsf"  #rsf file
